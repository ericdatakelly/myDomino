...
# Make a window to edit the calculation options
class calcOptionsWindow(Gtk.Window):

    def __init__(self):
        #Gtk.Window.__init__(self,title='MyTD') # This doesn't work.  Using Glade to set title instead.
        self.builder = Gtk.Builder()
        self.builder.add_from_file('MyTD_calcOptions.glade')
        ...
        self.window = self.builder.get_object('windowCalcOp')
    ...
    def on_buttonCancelCalcOp_clicked(self,widget):
        ...
        #self.on_windowCalcOp_destroy(widget)
...
class MyTDWindow(Gtk.Window):
    ...
    def __init__(self):
        #Gtk.Window.__init__(self,title='MyTD') # This doesn't work.  Using Glade to set title instead.
        self.builder = Gtk.Builder()
        self.builder.add_from_file('MyTD2.glade')
        ...
        handlersDict = {
            ...
            'on_buttonRun2_clicked':self.on_buttonRun2_clicked,
    ...
    def on_buttonEditCalcOp_clicked(self,widget):
        ...
        # Get the dataset name and create a list of available phases and soln models
        # (for now, just make text fields for the typical options, like Alm, Mg#, etc)

        # Get the default/last values
        #calcOptionsDict = storage.readCalcOptions('calcOptionsDict.txt')

        # Set the text values (populate the text fields)
        # ...set_text like below
        # on_buttonOK_clicked... get the current values, save a new Dict, and write them to the calcOptionsDict file
        # Does the dictionary need to be read within another class or is the dictionary in memory and accessible between classes?


    def on_buttonRun2_clicked(self,widget):
